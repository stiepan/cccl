...
#ifndef _CUDAX__LAZY_JIT_REPR_TYPE_TENSOR_COORD_ITERATOR_H
#define _CUDAX__LAZY_JIT_REPR_TYPE_TENSOR_COORD_ITERATOR_H
...
struct repr_type<::cuda::experimental::__tensor_coord_iterator<_Tp, _N>>
{
  static constexpr auto fixed_string =
    __fixed_string("cuda::experimental::__tensor_coord_iterator<") + repr_type<_Tp>::fixed_string + ", "
...
#endif // _CUDAX__LAZY_JIT_REPR_TYPE_TENSOR_COORD_ITERATOR_H
